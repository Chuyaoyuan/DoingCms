...
import io.yaoyuan.doingcms.domain.Tag;
import io.yaoyuan.doingcms.repository.TagRepository;
...
/**
 * REST controller for managing {@link io.yaoyuan.doingcms.domain.Tag}.
 */
@RestController
@RequestMapping("/api")
@Transactional
