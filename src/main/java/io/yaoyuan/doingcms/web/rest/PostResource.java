...
import io.yaoyuan.doingcms.domain.Post;
import io.yaoyuan.doingcms.repository.PostRepository;
...
/**
 * REST controller for managing {@link io.yaoyuan.doingcms.domain.Post}.
 */
@RestController
@RequestMapping("/api")
@Transactional
